...
-- Creation of Sales Representatives Table
...
-- Creation of Order Table (Fact Table linking common entities)
CREATE TABLE Orders (
...
-- Adding data to respective tables (5+ rows per table as requested) 
